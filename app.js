...
// EXERCISE 5:
let added = 0
for (morePoke of pokemon){
    if(morePoke.type=== 'fire'){
        game.party.push(morePoke)
        added+=1
    }
    if(added ===3){break}
}
...
// EXERCISE 6:
for (updateGym of game.gyms ){
    if(updateGym.difficulty < 3){
        updateGym.completed=true
    }
}
